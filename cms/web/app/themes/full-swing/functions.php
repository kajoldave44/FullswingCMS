...
?>
  <div class="wrap">
    ...
    <button data-env="development" class="deploy_button">Deploy Development</button>
  </div>
...
function handle_deploy()
{
  ...
  switch ($env) {
    case 'development':
      $url = "https://webhooks.amplify.us-east-1.amazonaws.com/prod/webhooks?id=63bedc73-5a5d-48ac-9f59-e50328a2f5e5&token=qklLYrz22tWShxlouFFcfImmTm18DM5ZuVrtYmp0AP4";
      break;
    case 'staging':
      $url = "https://webhooks.amplify.us-east-1.amazonaws.com/prod/webhooks?id=ec19ef15-29a0-4ee6-89d8-524cf9fc963e&token=HzjJU10tSBMoHI26oBo5zCmfhwmodLtg7f8FWrMQA";
      break;
    case 'production':
      $url = "https://webhooks.amplify.us-east-1.amazonaws.com/prod/webhooks?id=89fb8ce2-072c-4e06-8220-6c95351b4e5b&token=xLvV3jztENWICbRNpC3P7tNIpHyTwVhDoRBvgNG7jlE";
      break;
  }
